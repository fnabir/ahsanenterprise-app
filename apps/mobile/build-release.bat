...
if !exitCode! equ 0 (
    ...
    set "destAPK=%~dp0AhsanEnterprise-!finalVersion!.apk"
    
    REM Move and rename the APK to the target location
    if exist "!sourceAPK!" (
        move /Y "!sourceAPK!" "!destAPK!" >nul
        if !ERRORLEVEL! equ 0 (
            echo APK moved and saved as: !destAPK!
        ) else (
