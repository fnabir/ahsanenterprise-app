...
export default function Home() {
  return (
    <div className="grow h-full flex flex-col lg:flex-row divide-x-2 gap-2 px-2 lg:px-4">
      <div className="grow min-h-0 overflow-auto flex flex-col gap-4 pr-2 lg:pr-4 divide-y-2 pt-1.5 lg:pt-3 pb-2 lg:pb-4">
        <BalanceSection />
        <FilesSection />
      </div>

      <hr />
      <div className="min-h-0 overflow-auto w-full lg:w-1/5 shrink-0 flex flex-col gap-4 pt-1.5 lg:pt-3 pb-2 lg:pb-4">
        <ChangelogSection />
